...
#        idCmd+=1
        ...
        win32gui.InsertMenu(menu,0,win32con.MF_STRING,idCmd,"Edit Raapchik")
        win32gui.SetMenuItemBitmaps(menu,idCmd,0,self.hicon,self.hicon)
        idCmd+=1
        win32gui.InsertMenu(menu,1,win32con.MF_SEPARATOR,0,None)


        win32gui.InsertMenu(menu,2,win32con.MF_STRING,idCmd,"File Upload")
        win32gui.SetMenuItemBitmaps(menu,idCmd,0,self.hicon,self.hicon)
        idCmd+=1
		
        win32gui.InsertMenu(menu,3,win32con.MF_STRING,idCmd,"File Download")
        win32gui.SetMenuItemBitmaps(menu,idCmd,0,self.hicon,self.hicon)
        idCmd+=1
    ...
    def InvokeCommand(self, ci):
		...
		cmd = r'C:\Python27\code\compi\dist\play_sound.exe chick$1'
		win32api.WinExec(cmd,win32con.SW_SHOW)

		# cmd = r'C:\Python27\code\compi\dist\notify.exe dude its working'
		# win32api.WinExec(cmd,win32con.SW_SHOW)
